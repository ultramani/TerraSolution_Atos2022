...
Revision ID: 1782e92d7998
Revises: 8dbfa79bda36
Create Date: 2022-04-13 19:25:37.187747
...
revision = '1782e92d7998'
down_revision = '8dbfa79bda36'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('tbl_reports', sa.Column('polygonLocation', sa.BINARY(), nullable=False))
