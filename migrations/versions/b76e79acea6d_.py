...
Revision ID: b76e79acea6d
Revises: 1782e92d7998
Create Date: 2022-04-13 19:28:41.748591
...
revision = 'b76e79acea6d'
down_revision = '1782e92d7998'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('tbl_reports', sa.Column('polygonLocation', sa.BINARY(), nullable=True))
