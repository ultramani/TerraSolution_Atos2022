...
Revision ID: e8cf17aedbe4
Revises: 7cf44ec1f2a2
Create Date: 2022-04-24 14:58:02.268461
...
revision = 'e8cf17aedbe4'
down_revision = '7cf44ec1f2a2'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('avgMonthlyWindDirectionPlants', sa.ARRAY(sa.Float()), nullable=True),
